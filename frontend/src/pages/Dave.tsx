...
import { Plus, MapPin, Clock, Calendar, Star, Send, Trash2, Edit, ExternalLink } from 'lucide-react'
...
export function Dave() {
  ...
  const { data: venues, isLoading } = useQuery({
    queryKey: ['venues', 'dave'],
    queryFn: async () => {
      return apiFetch('/api/venues?user=dave') as Promise<Venue[]>
    }
  })
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <div className="h-16 w-16 rounded-full bg-gradient-to-br from-indigo-400 to-indigo-600 flex items-center justify-center">
            <span className="text-2xl font-bold text-white">D</span>
          </div>
          <div>
            <h1 className="text-3xl font-display font-bold text-gray-900">Dave's Space</h1>
            ...
            >
              ...
              {venue.website && (
                <a
                  ...
                  className="mt-3 text-sm text-indigo-600 hover:text-indigo-700 flex items-center"
                >
              ...
              {venue.status === 'PROPOSED' && !venue.event && (
                <button
                  ...
                  className="mt-3 w-full inline-flex items-center justify-center px-3 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 transition-colors"
                >
